...
export default function TimeSheet({
  ...
  return (
    <BottomSheet
      ...
      onClose={onClose}
      heightClass="h-auto max-h-[85%] pb-[20px]"
    >
      <div className="relative flex justify-center gap-6 py-2">
        {/* 선택 하이라이트 밴드 (중앙 한 줄, 연회색) */}
        <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-[40px] bg-[#F5F5F5] rounded-[10px] pointer-events-none" />
